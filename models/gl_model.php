...
class Gl_Model extends Model {
   ...
   */
   public function all() {
      return $this->_db->select('SELECT * FROM gl_table ORDER BY id DESC LIMIT 0, 20');
   }
   public function sum(){
      return $this->_db->select("SELECT count(*) as 'Summe' from gl_table");
   }
